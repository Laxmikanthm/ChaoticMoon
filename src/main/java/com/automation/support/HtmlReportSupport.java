...
//			TestEngine.FailNum = TestEngine.FailNum + 1;
	 ...
	 * 
	 */
	public static void onFailure(String strStepName, String strStepDes, String fileName) {
		
		String href = "./"+fileName.substring(fileName.indexOf("Screenshots"), fileName.length());
		Writer writer = null;
		try {
			File file = new File(TestEngine.filePath() + "/" + strTestName+"_Results"+
				/*	+ TestEngine.timeStamp + */".html");// "SummaryReport.html"
